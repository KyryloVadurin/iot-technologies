# Лабораторна робота № 14. Проєктування інтерактивного людино-машинного інтерфейсу (HMI Dashboard) для диспетчеризації та двонаправленого керування IoT-системами у середовищі Node-RED
